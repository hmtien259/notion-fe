  ...
  return (
    <section className="space-y-5">
      <div className="surface-card overflow-hidden rounded-[32px] border border-[var(--border)]">
        <div className="h-44 w-full" style={{ background: coverStyle ?? document.coverStyle ?? "linear-gradient(135deg, #e7d3bb, #a57b4a)" }} />
      ...
      <div className="surface-card relative rounded-[32px] border border-[var(--border)] px-6 py-8 sm:px-10">
